...
// New method to bind the texture as an image3D for the shader.
void Texture3D::BindAsImage(unsigned int unit, unsigned int level, bool layered, unsigned int layer, GLenum access, GLenum format)
{
